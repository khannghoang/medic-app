...
export default function Brands() {
  return (
    <section className="bg-slate-100 py-20 lg:py-[120px] dark:bg-dark">
        <h2 className="text-center pb-6 text-2xl font-bold">Trusted by</h2>
...
const SingleImage = ({ brand }: { brand: SingleImageProps }) => {
